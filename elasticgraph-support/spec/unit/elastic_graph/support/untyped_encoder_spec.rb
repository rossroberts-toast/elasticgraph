  ...
  module Support
    RSpec.describe UntypedEncoder do
      ...
      it "can apply hash key sorting even when the keys are of different types" do
        ...
        # CRuby: "comparison of String with 2 failed", JRuby: "comparison of Integer with String failed"
        expect { data.keys.sort }.to raise_error(/(comparison of String with (2|3) failed|comparison of Integer with String failed)/)
